...
public class Test {
	...
	public static void main( String[] args ) {
		...
		l.add(gui.creaGruppoLabelComponenteVerticale(new String[] {
				"User name:", "Password:", "Data: "
		},new Component[] {
			userName,gui.creaPasswordFieldSH(psw), gui.creaDateChooser()
		}));
		
		Finestra f = gui.creaFinestra( "Login", 220, 310, l, false );
		f.setResizable(false);
		
		f.add(gui.creaPanelloBottoni(new Bottone[] {
